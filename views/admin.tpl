...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand" href="#">ЦПМ</a>
      ...
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Система">
		  ...
		  <ul class="sidenav-second-level collapse" id="collapseSystem">
            <li>
              <a href="login.html">База данных</a>
            </li>
            <li>
              <a href="register.html">Статистика</a>
            </li>     
			<li>
              <a href="rfmtr.html">Росфин мониторинг</a>
            </li>			
          </ul>
        </li>
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Tables">
          <a class="nav-link" href="tables.html">
            ...
            <span class="nav-link-text">Таблицы</span>
          </a>
        </li>
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Example Pages">
          <a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" href="#collapseExamplePages" data-parent="#exampleAccordion">
            <i class="fa fa-fw fa-file"></i>
            <span class="nav-link-text">Отчёты</span>
          </a>
          <ul class="sidenav-second-level collapse" id="collapseExamplePages">
            <li>
              <a href="login.html">Сотрудник ДПМ</a>
            </li>
            <li>
              <a href="register.html">Филиал</a>
            </li>            
          </ul>
        </li>        
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Статистические данные</li>
      </ol>
    ...
    <footer class="sticky-footer">
      <div class="container">
        <div class="text-center">
          <small>Отчётность ЦПМ 2018 г</small>
        </div>
      </div>
    </footer>
